...
export const siteConfig: SiteConfig = {
	...
	featurePages: {
		anime: false, // 番剧 → 关闭
		diary: true, // 日记/动态 → Memos API
		friends: false, // 友链 → 关闭
		projects: false, // 项目 → 关闭
		skills: false, // 技能 → 关闭
		timeline: true, // 时间线/历程 → Memos API
		albums: false, // 相册 → 关闭
		devices: false, // 设备 → 关闭
		ticker: true, // Ticker 碎碎念
		todo: true, // TODO 清单
		dynamicBlog: true, // AI 动态博客（#blog 标签）
	},
	...
	diaryApiUrl: "/api/v1/memos",
	memosToken: "", // Memos PAT token，用于 TODO 交互编辑等操作
